...
const bureaus = [
  {
    title: "Startbureau",
    desc: "Alle vragen over inschrijven",
    button: "Mail Startbureau",
    href: "mailto:startbureau@avond4daagsedrunen.nl",
    color: "#E6007E",
    rotate: "-1.5deg",
  },
  {
    title: "Inschrijfbureau",
    desc: "Geen bevestigingsmail ontvangen?",
    button: "Mail Inschrijfbureau",
    href: "mailto:inschrijfbureau@avond4daagsedrunen.nl",
    color: "#2B9AC8",
    rotate: "1deg",
  },
  {
    title: "Stichting",
    desc: "Overige vragen of opmerkingen",
    button: "Contactformulier hieronder",
    href: "#contactform",
    color: "#8CB808",
    rotate: "-1deg",
  },
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F2]">
      <NavBar />
      <PageHero title="Contact" subtitle="Neem contact met ons op" />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="font-['Source_Sans_3'] text-[#4A4A4A]/80 space-y-2">
              ...
              <p>Rijnring 32, 5152 RA Drunen</p>
              <p>Tel: 06-17891087</p>
              <p>
                Penningmeester:{" "}
                <a
